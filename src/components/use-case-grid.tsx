...
export function UseCaseGrid() {
  return (
    <section className="relative py-[120px] px-4 overflow-hidden bg-background">
      <div className="container mx-auto max-w-7xl relative z-10">
        {/* Section Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 text-foreground">
        ...
        <BentoGrid className="max-w-6xl mx-auto">
          ...
          <MagicCard
            className="md:col-span-2 md:row-span-1 p-6 md:p-8 flex flex-col justify-between overflow-hidden"
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <LinkedIn className="w-8 h-8 transition-all duration-300 flex-shrink-0" />
            </div>
            <div className="flex-1 flex flex-col justify-end min-h-0">
              <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-2 leading-tight">
                Lead Generation
              </h3>
              <p className="font-mono text-xs md:text-sm text-muted-foreground mb-3 line-clamp-2">
              ...
              <div className="space-y-2 pt-3 border-t border-border/50">
                ...
                <div className="text-xs md:text-sm text-primary font-bold mt-2 flex items-center gap-2">
          ...
          <MagicCard
            className="md:col-span-1 md:row-span-1 p-6 md:p-8 flex flex-col justify-between overflow-hidden"
            ...
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex items-center gap-1.5 flex-shrink-0">
                <div className="w-8 h-8 rounded bg-black flex items-center justify-center">
                  <GitHub className="w-7 h-7 transition-all duration-300" />
                </div>
                <Reddit className="w-9 h-9 transition-all duration-300" />
            ...
            <div className="flex-1 flex flex-col justify-end min-h-0">
              ...
              <div className="pt-3 border-t border-border/50">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-green-500/10 border border-green-500/20 flex items-center justify-center flex-shrink-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
          ...
          <MagicCard
            className="md:col-span-1 md:row-span-1 p-8 flex flex-col justify-between"
          ...
          >
            <div className="flex justify-between items-start mb-6">
              ...
              <Airbnb className="w-8 h-8 transition-all duration-300 flex-shrink-0" />
            </div>
            <div className="flex-1 flex flex-col justify-end">
              ...
              <div className="pt-4 border-t border-border/50">
                <div className="inline-flex items-center gap-3 bg-primary/10 border border-primary/20 rounded-full px-4 py-2.5">
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <Gmail className="w-8 h-8 transition-all duration-300" />
                <Stripe className="w-9 h-9 transition-all duration-300" />
              </div>
            </div>
            <div className="flex-1 flex flex-col justify-end min-h-0">
              <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-2 leading-tight">
              ...
              <div className="space-y-2 pt-3 border-t border-border/50">
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="inline-flex items-center gap-1 bg-green-500/10 border border-green-500/20 rounded-full px-2 py-0.5">
                      <span className="text-xs font-bold text-green-500 whitespace-nowrap">
                        $12.4K
                      </span>
                    </div>
                  </div>
                  <span className="text-xl md:text-2xl font-bold text-foreground flex-shrink-0">
                    100%
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between text-xs pt-1 gap-2">
                  ...
                  <button className="px-3 py-1.5 bg-green-500/10 hover:bg-green-500/20 text-green-500 text-xs font-semibold rounded-lg transition-colors border border-green-500/20 flex-shrink-0">
                    Open Sheet
                  </button>
                </div>
              </div>
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <div className="w-8 h-8 rounded bg-black flex items-center justify-center">
                  <XformerlyTwitter className="w-6 h-6 transition-all duration-300" />
                </div>
                <Reddit className="w-8 h-8 transition-all duration-300" />
              </div>
            </div>
            <div className="flex-1 flex flex-col justify-end min-h-0">
              <h3 className="text-xl md:text-2xl font-bold text-foreground mb-2 leading-tight">
              ...
              <div className="pt-3 border-t border-border/50">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-blue-500/10 border border-blue-500/20 flex items-center justify-center flex-shrink-0">
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <Shopify className="w-8 h-8 transition-all duration-300 flex-shrink-0" />
            </div>
            <div className="flex-1 flex flex-col justify-end min-h-0">
              <h3 className="text-xl md:text-2xl font-bold text-foreground mb-2 leading-tight">
                Price Tracker
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <Reddit className="w-10 h-10 transition-all duration-300 flex-shrink-0" />
            </div>
            <div className="flex-1 flex flex-col justify-end min-h-0">
              <h3 className="text-xl md:text-2xl font-bold text-foreground mb-2 leading-tight">
                News Digest
              ...
              <div className="pt-3 border-t border-border/50 space-y-2">
                ...
                <button className="w-full px-3 py-2 bg-neutral-100 hover:bg-neutral-200 text-foreground text-xs font-semibold rounded-lg transition-colors border border-border">
                  Read Digest
                </button>
              </div>
            </div>
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <Google className="w-8 h-8 transition-all duration-300 flex-shrink-0" />
            </div>
            <div className="flex-1 flex flex-col justify-end min-h-0">
              <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-2 leading-tight">
                Smart Scheduler
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <WhatsApp className="w-8 h-8 transition-all duration-300 flex-shrink-0" />
            </div>
            <div className="flex-1 flex flex-col justify-end min-h-0">
              <h3 className="text-xl md:text-2xl font-bold text-foreground mb-2 leading-tight">
                Auto Responder
              ...
              <div className="pt-3 border-t border-border/50 space-y-2">
                ...
                <button className="w-full px-3 py-2 bg-green-500/10 hover:bg-green-500/20 text-green-500 text-xs font-semibold rounded-lg transition-colors border border-green-500/20">
                  Configure Responses
                </button>
              </div>
            </div>
